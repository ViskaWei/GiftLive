...
### 5.3 ⚠️ Cold Start 效应详解（重要）

> **现象**：Train RevCap@1%=29.4% 远低于 Test RevCap@1%=52.6%，差距 23pp

**不是数据泄漏！而是历史特征积累不足**：

| 日期 | RevCap@1% | pair_hist 非零率 | 说明 |
|------|-----------|------------------|------|
| Train 05-04 | **0.1%** | 0.00% | 数据集第一天，完全没历史 |
| Train 05-10 | 45.3% | 2.09% | 积累 6 天历史，接近 Test |
| Test 05-18 | 55.3% | 3.33% | 14 天历史，信息充足 |

**结论**：
- ✅ Day-Frozen 设计正确，无泄漏
- ✅ 模型依赖历史信息，历史越充足性能越好
- ✅ 实际部署时系统有足够历史，预期性能接近 Test (52.6%)
- ⚠️ **评估时不应将 Train RevCap 作为性能参考**
...
| 2026-01-19 | **新实验立项** | 3 个实验：指标落地(01) + 历史观看先验(02) + 样本加权回归(03) |
| 2026-01-19 | **MVP-3.1 指标体系落地完成** | RevCap@1%=52.6%, CV=10.8%, 统一报告模板已落地 |
