...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | line plot | Top-M | Top-1% Capture | `gift_allocation/img/mvp51_recall_vs_topk.png` |
| Fig2 | grouped bar | Method | Top-1% / Top-5% / NDCG@100 | `gift_allocation/img/mvp51_method_comparison.png` |
| Fig3 | line plot (dual y) | Top-M | Top-1% Capture / Recall Coverage | `gift_allocation/img/mvp51_tradeoff.png` |
| Fig4 | scatter | Direct Score Rank | Stage2 Score Rank | `gift_allocation/img/mvp51_score_correlation.png` |
...
| `gift_allocation/exp/exp_fair_comparison_20260108.md` | 基线数值参考 | - |
| `gift_allocation/exp/exp_two_stage_diagnosis_20260108.md` | Stage2 精排优势分析 | - |
...
- **路径**: `gift_allocation/exp/exp_recall_rerank_20260109.md`
...
- **格式**: JSON
- **路径**: `gift_allocation/results/recall_rerank_20260109.json`
- **内容**:
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_allocation_roadmap.md` | MVP-5.1 状态 + 结论快照 | §2.1 总览, §6.3 结论快照 |
| `gift_allocation_hub.md` | DG6 验证结果 + 洞见 | §决策空白, §洞见汇合 |
