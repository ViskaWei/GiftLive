...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | bar (grouped) | Policy | Total Revenue | `gift_allocation/img/mvp21_revenue_comparison.png` |
| Fig2 | bar (grouped) | Policy | Gini / Top-10% Share | `gift_allocation/img/mvp21_fairness_comparison.png` |
| Fig3 | scatter | Total Revenue | Gini (lower=fairer) | `gift_allocation/img/mvp21_pareto_frontier.png` |
| Fig4 | line | B (saturation param) | Revenue / Gini | `gift_allocation/img/mvp21_param_sensitivity.png` |
| Fig5 | line | N Users | Revenue Δ (Concave - Greedy) | `gift_allocation/img/mvp21_scale_effect.png` |
| Fig6 | lorenz (multi) | Cumulative % Streamers | Cumulative % Revenue | `gift_allocation/img/mvp21_lorenz_by_policy.png` |
...
### 5.1 实验报告
- **路径**: `gift_allocation/exp/exp_concave_allocation_20260108.md`
...
### 5.2 数值结果
- **路径**: `gift_allocation/results/concave_allocation_20260108.json`
- **内容**: 
  ```json
  {
    "policy_comparison": {
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_allocation_roadmap.md` | MVP-2.1 状态 + Gate-2 结果 | §1.2, §2.1, §4.2, §4.3 |
| `gift_allocation_hub.md` | DG3 验证 + Q2.1 答案 + 洞见 | §1, §5, §4 |
