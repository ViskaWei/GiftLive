...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | line (multi) | k值 | Overload Rate (per algorithm) | `gift_allocation/img/mvp53_overload_vs_k.png` |
| Fig2 | line (multi) | k值 | Streamer Gini (per algorithm) | `gift_allocation/img/mvp53_gini_vs_k.png` |
| Fig3 | line (multi) | k值 | Revenue Δ% vs Greedy (per algorithm) | `gift_allocation/img/mvp53_revenue_vs_k.png` |
| Fig4 | heatmap | Algorithm | k值 | Overload Rate (color) | `gift_allocation/img/mvp53_algorithm_comparison.png` |
| Fig5 | heatmap | Streamer ID | User ID (whale only) | Allocation Matrix | `gift_allocation/img/mvp53_distribution_heatmap.png` |
| Fig6 | bar (grouped) | Whale Threshold | Metrics (Overload/Gini/Revenue) | `gift_allocation/img/mvp53_threshold_sensitivity.png` |
| Fig7 | scatter | Streamer Gini | Revenue (per k) | `gift_allocation/img/mvp53_tradeoff_scatter.png` |
...
| `gift_allocation/results/shadow_price_20260109.json` | 基线收益参考 | - |
...
### 5.1 实验报告
- **路径**: `gift_allocation/exp/exp_whale_matching_20260109.md`
...
### 5.3 数值结果
- **路径**: `gift_allocation/results/whale_matching_20260109.json`
- **内容**: 
  ```json
  {
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_allocation_roadmap.md` | MVP-5.3 状态 + 结论快照 | §2.1, §6.3 |
| `gift_allocation_hub.md` | Gate-5C 结果 + DG8 关闭 + 洞见 | §1.2, §0 核心结论, §4 洞见汇合 |
