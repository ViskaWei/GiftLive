...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | bar (grouped) | OPE Method | Relative Error (mean ± std) | `gift_allocation/img/mvp31_ope_comparison.png` |
| Fig2 | bar (grouped) | OPE Method | Bias / Variance / MSE | `gift_allocation/img/mvp31_bias_variance.png` |
| Fig3 | line (multi) | N Logs | Relative Error | `gift_allocation/img/mvp31_sample_size_effect.png` |
| Fig4 | line (multi) | Epsilon (exploration) | Relative Error | `gift_allocation/img/mvp31_epsilon_effect.png` |
| Fig5 | box | OPE Method | Estimate Distribution | `gift_allocation/img/mvp31_estimate_distribution.png` |
| Fig6 | heatmap | Target Policy × OPE Method | Relative Error | `gift_allocation/img/mvp31_policy_ope_heatmap.png` |
...
### 5.1 实验报告
- **路径**: `gift_allocation/exp/exp_ope_validation_20260108.md`
- **模板**: `_backend/template/exp.md`

### 5.2 数值结果
- **路径**: `gift_allocation/results/ope_validation_20260108.json`
- **内容**: 
  ```json
  {
    "ope_comparison": {
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_allocation_roadmap.md` | MVP-3.1 状态 + Gate-3 结果 | §1.2, §2.1, §4.2 |
| `gift_allocation_hub.md` | Q3.1 答案 + OPE 设计原则 | §1, §6.1 |
