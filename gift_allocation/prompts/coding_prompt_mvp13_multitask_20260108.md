...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | bar | Model (Single vs Multi) | PR-AUC (has_gift) | `gift_allocation/img/mvp13_pr_auc_comparison.png` |
| Fig2 | line (multi-line) | Epoch | Loss (per task) | `gift_allocation/img/mvp13_training_curves.png` |
| Fig3 | bar grouped | Model | Top-1%/5%/10% Capture | `gift_allocation/img/mvp13_topk_capture.png` |
| Fig4 | heatmap | Task | Task (gradient conflict) | `gift_allocation/img/mvp13_gradient_conflict.png` |
| Fig5 | bar | Feature/Embedding dim | Importance (via ablation) | `gift_allocation/img/mvp13_shared_repr_analysis.png` |
...
### 5.1 实验报告
- **路径**: `gift_allocation/exp/exp_multitask_20260108.md`
...
### 5.3 数值结果
- **格式**: JSON
- **路径**: `gift_allocation/results/multitask_results_20260108.json`
- **内容**: 
  ```json
  {
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_allocation_roadmap.md` | MVP-1.3 状态 → ✅ + 结论快照 | §2.1, §4.3, §6.1 |
| `gift_allocation_hub.md` | DG5 验证结果 + 洞见 I10 | §5, §4 |
