...
> **Topic:** `gift_allocation` | **MVP:** MVP-1.4  
...
| Type | Link |
|------|------|
| 🧠 Hub | `gift_allocation/gift_allocation_hub.md` § H1-H4, DG1.1 |
| 🗺️ Roadmap | `gift_allocation/gift_allocation_roadmap.md` § MVP-1.4 |
| 📗 Prior Exp | `gift_allocation/exp/exp_fair_comparison_20260108.md` |
