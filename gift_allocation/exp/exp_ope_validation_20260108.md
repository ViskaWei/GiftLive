...
| 来源 | 链接 |
|------|------|
| Hub 问题 | Q3.1: OPE(IPS/DR)在高方差场景的有效性如何？ |
...
**路径**: `gift_allocation/img/mvp31_ope_comparison.png`
...
**路径**: `gift_allocation/img/mvp31_bias_variance.png`
...
**路径**: `gift_allocation/img/mvp31_sample_size_effect.png`
...
**路径**: `gift_allocation/img/mvp31_epsilon_effect.png`
...
**路径**: `gift_allocation/img/mvp31_estimate_distribution.png`
...
**路径**: `gift_allocation/img/mvp31_policy_ope_heatmap.png`
...
| 结果 JSON | `gift_allocation/results/ope_validation_20260108.json` |
| 图表目录 | `gift_allocation/img/mvp31_*.png` |
