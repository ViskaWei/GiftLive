...
> **Topic:** `gift_allocation` | **MVP:** MVP-1.3  
...
| Type | Link |
|------|------|
| 🧠 Hub | `gift_allocation/gift_allocation_hub.md` § DG5 |
| 🗺️ Roadmap | `gift_allocation/gift_allocation_roadmap.md` § MVP-1.3 |
...
| 结果 | `gift_allocation/results/multitask_results_20260108.json` |
| 图表 | `gift_allocation/img/mvp13_*.png` |
