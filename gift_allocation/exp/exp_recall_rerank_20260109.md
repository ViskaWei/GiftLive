...
> **Topic:** `gift_allocation` | **MVP:** MVP-5.1 (原MVP-4.3)  
...
| Type | Link |
|------|------|
| 🧠 Hub | `gift_allocation/gift_allocation_hub.md` § Gate-5A |
| 🗺️ Roadmap | `gift_allocation/gift_allocation_roadmap.md` § MVP-5.1 |
