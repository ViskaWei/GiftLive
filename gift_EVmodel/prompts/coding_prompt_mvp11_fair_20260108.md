...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | grouped bar | Model | Top-K% Capture | `../img/fair_comparison_topk.png` |
| Fig2 | line | Top-K% | Capture Rate | `../img/fair_comparison_topk_curve.png` |
| Fig3 | scatter | Predicted | Actual | `../img/fair_comparison_scatter.png` |
| Fig4 | 2×1 subplot | Feature | Importance | `../img/fair_comparison_feature_importance.png` |
| Fig5 | bar | Metric | Value | `../img/fair_comparison_all_metrics.png` |
...
4. **输出路径**:
   ...
   - 结果：`../results/fair_comparison_20260108.json`
   - 图表：`../img/fair_*.png`
...
### 5.1 实验报告
- **路径**: `exp/exp_fair_comparison_20260108.md`
...
### 5.3 数值结果
- **格式**: JSON
- **路径**: `../results/fair_comparison_20260108.json`
- **内容**:
```yaml
required_fields:
  - experiment_id
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `../gift_EVmodel_roadmap.md` | MVP-1.1-fair 状态 → ✅; 结论快照 | §2.1, §4.3 |
| `../gift_EVmodel_hub.md` | DG1 关闭状态; 更新共识表 | §5 DG1, §L1 K1 |
