...
> **Experiment ID:** `EXP-20260118-gift_EVmodel-01`  
> **MVP:** MVP-1.0  
> **Date:** 2026-01-18  
> **Author:** Viska Wei
...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | bar | Feature Name | Importance | `gift_EVmodel/img/leakage_free_feature_importance.png` |
| Fig2 | line | Top-K% (1%, 5%, 10%, ...) | Revenue Capture@K | `gift_EVmodel/img/leakage_free_revenue_capture.png` |
| Fig3 | line | Prediction Decile | Actual vs Predicted | `gift_EVmodel/img/leakage_free_calibration.png` |
| Fig4 | bar | Slice (Cold/Warm, Top1%/Top10%/Long-tail) | Performance Metric | `gift_EVmodel/img/leakage_free_slice_analysis.png` |
| Fig5 | bar | Model (Direct Frozen/Rolling, Two-Stage Frozen/Rolling) | Top-1% Capture / Revenue Capture@1% | `gift_EVmodel/img/leakage_free_direct_vs_twostage.png` |
...
### 5.1 实验报告
- **路径**: `gift_EVmodel/exp/exp_leakage_free_baseline_20260118.md`
...
### 5.3 数值结果
- **格式**: JSON
- **路径**: `gift_EVmodel/results/leakage_free_eval_20260118.json`
- **必须包含**:
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_EVmodel_roadmap.md` | MVP-1.0 状态更新 + 结论快照 | §2.1, §4.3 |
| `gift_EVmodel_hub.md` | 假设验证状态（H1.1, H1.2, H1.3）+ 洞见 | §1, §4 |
