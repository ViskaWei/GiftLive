...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | bar (grouped) | Policy | Revenue / Revenue_vs_Greedy% | `../img/mvp52_revenue_comparison.png` |
| Fig2 | heatmap | Constraint | Satisfaction Rate (per policy) | `../img/mvp52_constraint_satisfaction.png` |
| Fig3 | line (multi) | Round | Lambda Value (per constraint) | `../img/mvp52_lambda_convergence.png` |
| Fig4 | line | Learning Rate η | Revenue / Constraint Satisfy Rate | `../img/mvp52_lr_sensitivity.png` |
| Fig5 | bar (stacked) | Constraint Combo | Revenue Δ vs Greedy | `../img/mvp52_constraint_ablation.png` |
| Fig6 | scatter | Revenue | Constraint Satisfy (avg) | `../img/mvp52_pareto_frontier.png` |
...
| `../results/coldstart_constraint_20260108.json` | 冷启动λ=0.5 | - |
...
### 5.1 实验报告
- **路径**: `exp/exp_shadow_price_20260109.md`
...
### 5.3 数值结果
- **路径**: `../results/shadow_price_20260109.json`
- **内容**: 
  ```json
  {
    "policy_comparison": {
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_EVmodel_roadmap.md` | MVP-5.2 状态 + 结论快照 | §2.1, §6.3 |
| `gift_EVmodel_hub.md` | Gate-5B 结果 + DG7 关闭 + 洞见 | §1.2, §0 核心结论 |
