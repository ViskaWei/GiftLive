...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | bar (grouped) | Metric | Value (Real vs Simulated) | `../img/mvp03_calibration_comparison.png` |
| Fig2 | histogram (overlay) | Gift Amount (log scale) | Frequency | `../img/mvp03_amount_distribution.png` |
| Fig3 | lorenz curve | Cumulative % Users | Cumulative % Revenue | `../img/mvp03_lorenz_curve.png` |
| Fig4 | bar (grouped) | Policy | Total Revenue / Gini | `../img/mvp03_policy_preview.png` |
| Fig5 | line | Gamma (externality) | Total Revenue / Fairness | `../img/mvp03_externality_sweep.png` |
...
| `../results/eda_stats_20260108.json` | 真实数据统计作为校准目标 | - |
...
### 5.1 实验报告
- **路径**: `exp/exp_simulator_v1_20260108.md`
...
### 5.3 数值结果
- **格式**: JSON
- **路径**: `../results/simulator_v1_20260108.json`
- **内容**: 
  ```json
  {
    "calibration": {
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_EVmodel_roadmap.md` | MVP-0.3 状态 → ✅ + 结论快照 | §2.1, §4.3 |
| `gift_EVmodel_hub.md` | Q3.2 验证状态 + Simulator 参数 | §1, §6.2 |
