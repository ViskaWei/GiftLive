...
| 图号 | 图表类型 | X轴 | Y轴 | 保存路径 |
|------|---------|-----|-----|---------|
| Fig1 | bar (grouped) | Policy | Revenue / Cold Start Success | `../img/mvp22_constraint_effect.png` |
| Fig2 | scatter | Revenue Loss % | Cold Start Success Δ | `../img/mvp22_tradeoff_scatter.png` |
| Fig3 | line | Min Allocation per New | Revenue Loss / Success Rate | `../img/mvp22_constraint_strength.png` |
| Fig4 | line (multi) | Round | Cumulative Coverage | `../img/mvp22_coverage_over_time.png` |
| Fig5 | bar | Policy | Ecosystem Diversity (Entropy) | `../img/mvp22_ecosystem_diversity.png` |
...
### 5.1 实验报告
- **路径**: `exp/exp_coldstart_constraint_20260108.md`
- **模板**: `_backend/template/exp.md`

### 5.2 数值结果
- **路径**: `../results/coldstart_constraint_20260108.json`
- **内容**: 
  ```json
  {
...
| 目标文件 | 更新内容 | 章节 |
|---------|---------|------|
| `gift_EVmodel_roadmap.md` | MVP-2.2 状态 + Gate-2 综合结果 | §1.2, §2.1, §4.2 |
| `gift_EVmodel_hub.md` | Q2.3 答案 + P6 原则验证 | §1, §6.2 |
