...
> **Name:** Simulator V1
> **ID:** `EXP-20260118-gift_EVmodel-02`
> **Topic:** `gift_EVmodel` | **MVP:** MVP-2.0
...
| Type | Link |
|------|------|
| 🧠 Hub | `../gift_EVmodel_hub.md` § Q4 |
| 🗺️ Roadmap | `../gift_EVmodel_roadmap.md` § MVP-2.0, Gate-3 |
...
- 上游实验：`exp_leakage_free_baseline_20260118.md`
- Hub 链接：`../gift_EVmodel_hub.md` § Q4
- Roadmap 链接：`../gift_EVmodel_roadmap.md` § MVP-2.0
